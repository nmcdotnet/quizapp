...
public final class DialogDeleteBinding implements ViewBinding {
  ...
  private DialogDeleteBinding(@NonNull LinearLayout rootView, @NonNull TextView btnNo,
      @NonNull TextView btnYes, @NonNull TextView txtHighScore) {
  ...
  public static DialogDeleteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogDeleteBinding((LinearLayout) rootView, btnNo, btnYes, txtHighScore);
    }
