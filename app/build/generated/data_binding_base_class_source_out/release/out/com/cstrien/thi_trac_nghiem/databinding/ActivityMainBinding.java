...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView, @NonNull TextView btnBack,
      @NonNull TextView btnHome, @NonNull TextView btnStart, @NonNull Spinner spCategory,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, btnBack, btnHome, btnStart,
          spCategory, txtTieuDe, txtUserName);
    }
